...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        ...
        """
        # list.append() provide O(1) operation,but list.insert(val,index) provide O(n)
        # dictionary value search O(1), it is not ordered.
    ...
    def remove(self, val: int) -> bool:
        ...
        if val in self.dict:
            index = self.dict[val]
            lastelement = self.list[len(self.list) - 1]
